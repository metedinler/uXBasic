...
## Sira 8.Q - Win11 Low-Level Guvenli Alt Kume Dalgasi
- Durum: tamamlandi
- Gorev: Win11 user-mode gercekcilik sinirlarini bozmadan parser+expr-validation seviyesinde guvenli alt kumeyi kapsama almak (`INC`, `DEC`, `POKEB`, `MEMCOPYB`, `MEMFILLB`, `VARPTR`, `SADD`, `CODEPTR`, `LPTR`, `PEEKB`, `CPUFLAGS`)
- Sorumlu: Agent-Backend64
- Cikti:
	- `src/parser/lexer/lexer_keyword_table.fbs`
	- `src/parser/parser/parser_shared.fbs`
