...
| Calling convention: stdcall/cdecl secimi | OK | OK | OK | KISMEN | OK | Parser+runtime token destegi aktif (CDECL/STDCALL). Win64 runtime invoke lane'i I32 disina genisletildi (U64/F64/PTR/STRPTR/BYREF/BYVAL, 0..4 arg) ve ek smoke kaniti eklendi (tests/run_call_dll_x64_signature_runtime_smoke.bas). x86 native lane raporunda gerekli probe satirlari PASS/PASS olsa da host-bagimli SKIP oldugu icin R=KISMEN korunur. | FFI-CONV-1 |
