...
cd /d "%~dp0..\..\.."
if "%~1"=="" (
  echo Usage: run_uxb_ast_alias_overlay.bat source.bas
  exit /b 2
)
...
uxb\compiler\wrappers\uxb_main_wrapper_64.exe "%TMP%" --execmem --interpreter-backend AST --console-mode direct
exit /b %ERRORLEVEL%
